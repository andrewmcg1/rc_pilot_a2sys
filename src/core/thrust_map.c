 ...
 * Thrustr units in kgf
 */
static const int eco2807_4s_points = 21;
static double eco2807_4s_map[][2] = {{0.00, 0.0000}, {0.05, 0.0001}, {0.1, 0.0218}, {0.15, 0.0787}, 
    {0.2, 0.1495}, {0.25, 0.2398}, {0.3, 0.3410}, {0.35, 0.4556}, {0.4, 0.5779}, {0.45, 0.7014}, 
    {0.5, 0.8392}, {0.55, 0.9554}, {0.6, 1.0829}, {0.65, 1.1999}, {0.7, 1.3162}, {0.75, 1.4001}, 
    {0.8, 1.4834}, {0.85, 1.5672}, {0.9, 1.6172}, {0.95, 1.6650}, {1.0, 1.6770}};
